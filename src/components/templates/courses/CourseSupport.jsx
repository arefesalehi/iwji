...
const CourseSupport = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white mt-10 mb-20 p-10 rounded-[20px] w-full h-auto text-md text-justify [box-shadow:rgba(60,_64,_67,_0.3)_0px_1px_2px_0px,_rgba(60,_64,_67,_0.15)_0px_1px_3px_1px]">
        <h1 className="mt-5 mb-2 font-semibold text-red-800 text-base lg:text-lg">
          {t('supportLearningTitle')}
        </h1>
        <p className="py-2">{t('supportLearningText')}</p>
