    ...
    <>
      <div className="bg-white m-auto mt-20 pt-5 pb-3 rounded-[20px] w-full md:w-[90%] h-auto overflow-hidden text-sm lg:text-base">
        <ul className="flex md:flex-col justify-center md:justify-start items-center md:items-start text-xs md:text-base">
          ...
          <div className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white">
            {' '}
            <Link href="/user-account/transaction" className="">
              تراکنش ها
            </Link>
          </div>{' '}
          <div className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white">
            <Link href="/user-account/tickets">تیکت ها</Link>
          </div>
          <div className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white">
            {' '}
            <Link href="/user-account/myWebinars">وبینارهای من</Link>
          </div>
          <div className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white">
            {' '}
            <Link href="/user-account/IIWmembership"> عضویت IIW</Link>
          </div>
          <div className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white">
            {' '}
            <Link href="/user-account/accountDetail"> جزئیات حساب</Link>
          </div>
          <div
            onClick={logout}
            className="hover:bg-red-800 mb-3 p-4 border-gray-300 border-r-6 hover:rounded-tl-[30px] hover:rounded-bl-[90px] w-[80%] hover:text-white"
          >
            {' '}
            <Link href=""> خروج</Link>
          </div>
