...
const TeamBox = ({img, username, position}) => {
  return (
    ...
    <div className='flex flex-col items-center bg-gray-200 rounded-[20px] w-[280px] h-[450px]'>
        ...
        <Image alt='pic' src={img} width={220} height={200} className='rounded-[0px] w-[220px] h-[200px]'  />
        ...
        <button className='bg-gray-500 mt-5 px-18 py-2 rounded-[10px] text-white'>مشاهده رزومه</button>
