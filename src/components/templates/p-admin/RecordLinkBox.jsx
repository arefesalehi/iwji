...
import RecordlinkTable from './RecordlinkTable'
import swal from 'sweetalert'
export default function RecordLinkBox({ courseRegisterations, courseOptions }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/recordinglink', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          title,
  ...
  return (
    <>
         <div className="bg-white m-auto py-10 rounded-lg w-[90%]"> <div className="bg-white shadow mx-auto mt-10 p-6 rounded-xl max-w-lg">
        <h2 className="mb-4 font-bold text-xl">ایجاد لینک ضبط جدید</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="مثلاً: لینک ضبط کلاس"
              required
            />
          </div>
      ...
      <RecordlinkTable courseRegisterations={all} deleteUser={deleteUser} /></div>
