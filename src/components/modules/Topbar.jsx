  ...
  return (
    <div className="flex justify-center items-center bg-gray-200 py-5 w-full h-auto">
      <div className="md:flex md:flex-row flex-col justify-between items-center h-auto container">
        ...
        <div className="flex">
          <div className="flex justify-center items-center hover:bg-red-800 ml-2 border border-red-900 border-solid rounded-[10px] w-[52px] h-[60px] text-red-800 hover:text-white transition-all duration-600 ease-in-out">
